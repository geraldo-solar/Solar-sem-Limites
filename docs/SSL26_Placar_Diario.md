...
“Não apurado” não significa zero. Não preencher vendas com campanhas antigas ou testes. Captação histórica e audiência atualmente elegível são contagens diferentes: saída bloqueia mensagens, mas não apaga o fato histórico do cadastro.

## 2. Rotina da equipe — proposta de trabalho

Conferência às **9h e 17h** durante a campanha; não foi criado lembrete, agendamento ou monitoramento automático.
...
| Indicador | Fonte / regra de conferência |
|---|---|
| Leads do dia e acumulados | Cadastro/ERP e Brevo conciliados; só SSL26 novembro, sem testes/identidades duplicadas |
| Origem e perfil | UTMs e resposta salva; origem desconhecida e perfil vazio explícitos, sem atribuição inventada |
| Elegíveis para e-mail / WhatsApp | Consentimento do canal, saída, atendimento e compra revalidados; lista total não é público liberado |
| Investimento e CPL pago | Meta Ads conciliado com leads pagos válidos; R$ 14,29 é referência, não garantia ou autorização de gasto |
| Guia, canal e e-mails | Separar clique, seguidores agregados, aceite, entrega e clique de e-mail; clique não prova que seguiu o canal |
| Live / replay | Dados reais do provedor; visualizações repetidas não são pessoas únicas |
| Pedidos e compradores | IDs de pedidos e compradores únicos; uma compra pode conter duas unidades |
| Pacotes confirmados, cancelados e pendentes | ERP e provedor; pendentes não contam como vendas aprovadas |
...
Na meta, somar cada pedido aprovado **uma vez**, pelos valores efetivos. Mostrar lado a lado faturamento-base e acréscimos, sem apresentar acréscimo do cartão como aumento de quantidade vendida. Pedidos pagos depois do corte dependem da decisão **VEN-06**.

## 4. Fórmulas de acompanhamento

- **Progresso financeiro:** faturamento bruto válido ÷ R$ 600.000 × 100. Mostrar acima de 100% se superar a meta.
- **Falta para a meta:** maior valor entre zero e R$ 600.000 − faturamento bruto válido.
- **Referência em unidades ao preço-base:** 194 × R$ 3.100 = R$ 601.400. Não é quantidade de compradores nem substitui conciliação financeira.
...
## 5. Registro de captação e decisões

Duplicar este bloco a cada conferência, com data/horário reais, sem sobrescrever anteriores:

| Campo | Preenchimento |
|---|---|
| Data / horário / responsável | A preencher |
| Fonte e horário dos dados | A preencher |
| Leads do dia / acumulados / origem desconhecida | Não apurado |
| Pagos / base / orgânico / indicação | Não apurado; metas 3.500 / 700 / 500 / 300 |
| Público elegível por canal | Não apurado |
| Investimento acumulado / CPL pago | Não apurado |
| Fila, saídas e falhas | Não apurado |
| Decisão / responsável / prazo / aprovação necessária | A preencher |

A referência de aproximadamente 121 leads pagos/dia é 3.500 ÷ 29, de 26/10 a 23/11. Os cerca de 172 leads/dia do plano se referem à meta **total** de 5.000 nesse intervalo de referência, não a 172 leads pagos todo dia. São médias de planejamento; base/orgânico podem entrar antes. Analisar por origem.

## 6. Diário do carrinho — valores reais a preencher

**— = não apurado**, não zero. Pacotes acumulados devem refletir cancelamentos conhecidos, com ajuste registrado. Faturamento é acumulado; não somar os acumulados entre dias.

| Data | Pacotes do dia | Pacotes acumulados válidos | Faturamento bruto válido acumulado | Falta para R$ 600 mil | Conferência / pendências |
|---|---:|---:|---:|---:|---|
| 25/11 | — | — | — | — | Não apurado; abertura prevista às 8h |
| 26/11 | — | — | — | — | Não apurado |
| 27/11 | — | — | — | — | Não apurado |
| 28/11 | — | — | — | — | Não apurado |
| 29/11 | — | — | — | — | Não apurado |
...
| Situação | Ação, sem execução automática |
|---|---|
...
## 8. Fechamento e relatório final
...
Resultado final: **meta atingida / não atingida / apuração pendente**. Só escolher depois da conferência. Pagamento, cancelamento ou dado inconclusivo permanece identificado; não afirmar lucro apenas porque houve R$ 600 mil de faturamento.

## 9. Aceite para transformar o modelo em painel no ERP

Entrega **MET-02**, pendente. O painel precisa:

- Mostrar só a campanha de novembro, excluir QA e distinguir dados reais de simulação.
- Controlar acesso da equipe e não expor dados pessoais nos resumos.
- Mostrar fonte, horário e indisponibilidade de cada integração.
- Separar pedidos, compradores, unidades, faturamento e recebimento.
- Tratar duplicatas, pagamento combinado, devolução parcial, evento fora de ordem e zero/ausência de dados.
- Manter histórico de conciliação/decisões sem habilitar gastos, mensagens ou reabertura automática.
- Passar em teste com registros controlados antes de anunciar atingimento de meta.

Este documento não implementa nem simula conexão automática. Nenhuma consulta de faturamento real, envio, anúncio ou alteração no ERP foi realizada nesta consolidação.
