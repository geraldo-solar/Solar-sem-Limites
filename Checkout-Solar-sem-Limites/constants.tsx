...
export const Icons = {
  ...
  Visa: () => (
    <img src={getImg("visa.png")} alt="Visa" className="h-6 w-auto object-contain" />
  ),
  Mastercard: () => (
    <img src={getImg("mastercard.png")} alt="Mastercard" className="h-6 w-auto object-contain" />
  ),
  Amex: () => (
    <img src={getImg("amex.png")} alt="American Express" className="h-6 w-auto object-contain" />
  ),
  Elo: () => (
    <img src={getImg("elo.png")} alt="Elo" className="h-6 w-auto object-contain" />
  ),
